      ...
      <Dialog onOpenChange={(isOpen) => !isOpen && setActive(false)}>
        <DialogTrigger onClick={() => setActive(true)}>
          {state ? (
            ...
            <h2
              className={`${
                active ? "border-b-2 rounded-none border-foreground" : ""
        ...
        <DialogContent className="bg-background">
          <ScrollArea className="h-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload an image or video. We recommend using high-quality .jpg
                files less than 20 MB or .mp4 files less than 200 MB
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {keywords.map((keyword, index) => (
                    <span
                      key={index}
                      className="bg-muted text-muted-foreground px-3 py-1 rounded-full"
                    >
                      {keyword}
                      <Button
                        onClick={() =>
