    ...
    <div className="flex flex-row gap-10 ">
        ...
        <div className="flex mt-5 flex-col p-5 gap-5 w-3/5 mb-40">
            ...
            >
              <DialogTrigger asChild>
                <Button
                  variant="muted"
                  size={30}
                  className="bg-muted text-lg text-foreground p-3 rounded-3xl shadow-none"
                >
                  Change
                </Button>
              </DialogTrigger>
              <DialogContent>
                ...
                <DialogFooter>
                  <DialogClose>
                    <Button
                      onClick={(e) =>
                        setData((prevData) => ({ ...prevData, photo: url }))
                      }
                    >
                      Save
                    </Button>
          ...
          <div className="flex gap-2 w-full">
            <div className="flex flex-col gap-2 w-full">
              <Label
                htmlFor="firstName"
                className="text-md text-left text-foreground"
              >
                First Name
              </Label>
              <Input
          ...
          <div className="flex flex-col w-full gap-2">
            ...
            />
            {same ? (
              <h2 className="text-sm  text-primary">username taken</h2>
            ) : (
      ...
      <div className="fixed flex gap-2 justify-end p-5 h-2/10 border-t-2 bg-background bottom-0 w-full shadow-xl m-0">
        ...
        <Button
          ...
          onClick={() => handleSave()}
          size={30}
          className=" text-lg p-3 rounded-3xl shadow-none"
        >
          Save
        </Button>
      </div>
